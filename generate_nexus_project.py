...
class BootReceiver : BroadcastReceiver() {
    ...
    # 7. build.gradle (Updated AGP 8.0.2 & Kotlin 1.8.20)
...
dependencies {
    ...
    print("[+] Project generation complete with AGP 8.0.2 and JDK 17 support!")
