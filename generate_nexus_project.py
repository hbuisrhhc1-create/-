...
def create_full_project():
    ...
    print(f"[*] Generating project for '{APP_NAME}' with updated Gradle configuration...")
...
class BootReceiver : BroadcastReceiver() {{
    ...
    # 9. build.gradle (Root) - עודכן לגרסת AGP 8.1.4 שמתאימה מושלם לגרסאות חדשות
...
include ':app'"""
    ...
    # 11. app/build.gradle - עודכן ל-Compile/Target SDK 34 ו-Kotlin 1.9
...
dependencies {{
    ...
    print("[+] Project updated successfully with modern Gradle & AGP versions!")
